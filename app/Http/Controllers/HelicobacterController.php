...
class HelicobacterController extends Controller
{
    ...
    public function nuevo(Request $request)
    {
        ...
        $doctores = Doctor::all();
        return view('laboratorio.helicobacter.nuevo', compact('doctores', 'ultimaCita', 'primeraVez'));
    }
    ...
    public function editar(Request $request)
    {
        ...
        return view('laboratorio.helicobacter.editar', compact('ultimaCita', 'primeraVez', 'texto', 'datos'));
    }
