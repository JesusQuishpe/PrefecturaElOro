    ...
    <fieldset>
        <div class="grid-form">
            ...
            <div class="grid-form-item">
                ...
                <input type="text" name="colestero_ltotal">
            </div>
            <div class="grid-form-item">
            ...
            <div class="grid-form-item">
                <span>Tridliceridos:</span>
                <input type="text" name="tridliceridos">
            </div>
            <div class="grid-form-item">
            ...
            <div class="grid-form-item">
                ...
                <input type="text" name="gamma_glutamil">
            </div>
            <div class="grid-form-item">
                <span>Calcio:</span>
        ...
        <div class="grid-form">
            ...
            <div class="grid-form-item">
                ...
                <input type="text" name="proteina_react">
            </div>
            <div class="grid-form-item">
                <span>R.A test (latex):</span>
                <input type="text" name="ra_test">
            </div>
            <div class="grid-form-item">
                <span>A.S.T.O:</span>
            ...
            <div class="grid-form-item">
                ...
                <input type="text" name="proteus_019">
            </div>
            <div class="grid-form-item">
                <span>Proteus 0x2:</span>
                <input type="text" name="proteus_02">
            </div>
            <div class="grid-form-item">
                <span>Proteus 0xK:</span>
                <input type="text" name="proteus_0k">
            </div>
        </div>
        <h3>Enzimas</h3>
        <div class="grid-form">
            <div class="grid-form-item">
                ...
                <input type="text" name="transaminasa_0x">
            </div>
            <div class="grid-form-item">
            ...
            <div class="grid-form-item">
                ...
                <input type="text" name="fosfatasa_adulto">
            </div>
            <div class="grid-form-item">
                <span>Fosfatasa alcalina niño:</span>
                <input type="text" name="fosfatasa_niño">
            </div>
            <div class="grid-form-item">
                <span>Amilasa:</span>
